...
import { ArrowLeft, Download, QrCode, Users, Activity, Settings, LogOut } from "lucide-react"

// Mock data for the admin dashboard
const mockQrData = [
  { id: 1, url: "https://restaurant-example.com", type: "restaurant", created: "2023-05-15", scans: 245 },
  { id: 2, url: "https://retail-store.com", type: "retail", created: "2023-05-16", scans: 189 },
  { id: 3, url: "https://tech-company.com", type: "tech", created: "2023-05-17", scans: 321 },
  { id: 4, url: "https://healthcare-provider.com", type: "healthcare", created: "2023-05-18", scans: 142 },
  { id: 5, url: "https://education-platform.com", type: "education", created: "2023-05-19", scans: 276 },
]
    ...
    <div className="min-h-screen bg-black">
      <div className="flex">
        ...
        <div className="w-64 bg-gray-900/60 border-r border-purple-500/30 h-screen fixed">
          ...
          <nav className="mt-6">
            <div className="px-4 py-2 text-cyan-400 text-sm font-medium uppercase">Main</div>
            <Button
              variant="ghost"
            ...
            <div className="px-4 py-2 mt-6 text-cyan-400 text-sm font-medium uppercase">Settings</div>
            <Button
              variant="ghost"
              className="w-full justify-start text-white hover:bg-purple-900/30 hover:text-cyan-400 py-3 px-6"
            >
        ...
        <div className="ml-64 flex-1 p-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <Button variant="outline" asChild className="border-purple-500/50 text-purple-400 hover:bg-purple-950/30">
              <a href="/">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <Card className="bg-gray-900/60 border border-purple-500/30 shadow-lg shadow-purple-500/20">
              <CardHeader className="pb-2">
                <CardDescription className="text-cyan-400">Total QR Codes</CardDescription>
            ...
            <Card className="bg-gray-900/60 border border-purple-500/30 shadow-lg shadow-purple-500/20">
              <CardHeader className="pb-2">
                <CardDescription className="text-cyan-400">Total Scans</CardDescription>
                <CardTitle className="text-3xl text-white">1,286</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-sm text-green-400">+24% from last month</div>
              </CardContent>
            </Card>

            <Card className="bg-gray-900/60 border border-purple-500/30 shadow-lg shadow-purple-500/20">
              <CardHeader className="pb-2">
                <CardDescription className="text-cyan-400">Active Users</CardDescription>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            <Card className="bg-gray-900/60 border border-purple-500/30 shadow-lg shadow-purple-500/20">
              <CardHeader>
                <CardTitle className="text-xl text-white">QR Scans (Last 7 Days)</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={scanData}>
                      ...
                      />
                      <Bar dataKey="scans" fill="url(#colorGradient)" radius={[4, 4, 0, 0]} />
                      <defs>
            ...
            <Card className="bg-gray-900/60 border border-purple-500/30 shadow-lg shadow-purple-500/20">
              <CardHeader>
                <CardTitle className="text-xl text-white">QR Codes by Business Type</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
          ...
          <Card className="bg-gray-900/60 border border-purple-500/30 shadow-lg shadow-purple-500/20">
            <CardHeader>
              <CardTitle className="text-xl text-white">Recent QR Codes</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="overflow-x-auto">
                <table className="w-full text-sm text-left text-gray-300">
                  ...
                  <tbody>
                    {mockQrData.map((qr) => (
                      <tr key={qr.id} className="border-b border-gray-700 hover:bg-gray-800/50">
                        <td className="px-6 py-4">{qr.id}</td>
                        <td className="px-6 py-4 font-mono text-xs truncate max-w-xs">{qr.url}</td>
