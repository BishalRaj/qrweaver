  ...
  return (
    <div className="container mx-auto">
            ...
            <Tabs defaultValue="generate" value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="generate" className="space-y-6 mt-2">
                <div className="space-y-5">
                  <div>
                    <Label htmlFor="url" className="text-gray-200 text-base font-medium mb-1.5 block">
                      Destination URL
                    </Label>
                    <Input
                      id="url"
                  ...
                  <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700/50">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="redirect-mode" className="text-gray-200 font-medium cursor-pointer">
                    ...
                    {useRedirect && (
                      <div className="text-sm text-gray-400 mt-2">
                        QR code will point to our secure server first, then redirect to your URL. This enables scan
                        tracking, analytics, and enhanced security.
                      </div>
                    )}
                  </div>

                  <div>
                    <Label htmlFor="business-type" className="text-gray-200 text-base font-medium mb-1.5 block">
                      Business Type
                    </Label>
              ...
              <TabsContent value="customize" className="space-y-6 mt-2">
                <div className="space-y-5">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      <Label htmlFor="primary-color" className="text-gray-200 text-base font-medium mb-1.5 block">
                        Primary Color
                      </Label>
                    ...
                    <div>
                      <Label htmlFor="secondary-color" className="text-gray-200 text-base font-medium mb-1.5 block">
                        Secondary Color
                      </Label>
                      <div className="flex gap-2">
                        <div className="relative">
                  ...
                  <div>
                    <div className="flex justify-between mb-1.5">
                      <Label htmlFor="size" className="text-gray-200 text-base font-medium">
                        QR Code Size
                      </Label>
                  ...
                  <div className="flex items-center space-x-2 bg-gray-800/30 rounded-lg p-4 border border-gray-700/50">
                    ...
                    />
                    <Label htmlFor="include-margin" className="text-gray-200 font-medium cursor-pointer">
                  ...
                  <div className="flex justify-between gap-4 pt-2">
                    ...
                    >
                      Continue to Branding <ChevronRight className="ml-2 h-4 w-4" />
                    </Button>
                  </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="branding" className="space-y-6 mt-2">
                <div className="space-y-5">
                  <div>
                    <Label htmlFor="business-initials" className="text-gray-200 text-base font-medium mb-1.5 block">
                      Business Initials
                    </Label>
                    <Input
                      ...
                      onChange={(e) => setBusinessInitials(e.target.value.substring(0, 2).toUpperCase())}
                      placeholder="AB"
                      maxLength={2}
                      className="bg-gray-800/50 border-gray-700 focus:border-purple-500 text-white"
                    />
                    <p className="text-sm text-gray-400 mt-1.5">
                      Enter up to 2 characters to display in the center of your QR code
                    </p>
                  </div>

                  <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700/50">
                    <Label className="text-gray-200 text-base font-medium mb-3 block">Custom Logo (Optional)</Label>
                    <input
                      type="file"
                      ref={fileInputRef}
                    ...
                    <p className="text-sm text-gray-400 mt-3">
                      Your logo will be placed in the center of the QR code. For best results, use a simple logo with
        ...
        <Card className="lg:col-span-2 bg-gray-900/80 border border-gray-800 shadow-xl">
          <CardContent className="p-6">
            <div className="text-center mb-4">
              ...
              <p className="text-sm text-gray-400">See how your QR code will look</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              <div className="relative p-6 rounded-xl bg-gradient-to-r from-gray-900 to-gray-800 border border-gray-800 shadow-lg flex items-center justify-center">
                ...
                <div className="relative z-10 flex flex-col items-center">
                  <div className="relative group">
                    ...
                    <div className="relative p-6 bg-black rounded-lg" id="qr-code-container">
                      <div className="relative">
                        <QRCodeSVG
                          value={getQrUrl()}
                          size={size}
              ...
              <div className="mt-6 text-center">
                ...
                <p className="text-white font-mono text-sm truncate max-w-xs">{url}</p>
                {useRedirect && (
      ...
      <div className="mt-8 text-center">
        <Button variant="link" asChild className="text-gray-400 hover:text-cyan-400">
